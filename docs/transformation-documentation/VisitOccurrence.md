...
# VisitOccurrence
* [NhsNumber]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_NhsNumber.md %})
* [HospitalProviderSpellNumber]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_HospitalProviderSpellNumber.md %})
* [visit_start_date]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_visit_start_date.md %})
* [visit_start_datetime]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_visit_start_datetime.md %})
* [visit_end_date]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_visit_end_date.md %})
* [visit_end_datetime]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_visit_end_datetime.md %})
* [visit_concept_id]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_visit_concept_id.md %})
* [visit_type_concept_id]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_visit_type_concept_id.md %})
* [admitted_from_source_value]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_admitted_from_source_value.md %})
* [admitted_from_concept_id]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_admitted_from_concept_id.md %})
* [discharged_to_concept_id]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_discharged_to_concept_id.md %})
* [discharged_to_source_value]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_discharged_to_source_value.md %})
* [RecordConnectionIdentifier]({% link oxford-omop-data-mapper/docs/transformation-documentation/VisitOccurrence_RecordConnectionIdentifier.md %})
