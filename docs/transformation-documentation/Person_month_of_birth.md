...
[Comment or raise an issue for this mapping.](https://github.com/answerdigital/oxford-omop-data-mapper/issues/new?title=OMOP%20Person%20table%20month_of_birth%20field%20SACT%20mapping){: .btn }
### Rtds Demographics
Source column  `DateOfBirth`.
Selects the month of the year or null if the date is null.
...
[Comment or raise an issue for this mapping.](https://github.com/answerdigital/oxford-omop-data-mapper/issues/new?title=OMOP%20Person%20table%20month_of_birth%20field%20CDS%20Person%20mapping){: .btn }
