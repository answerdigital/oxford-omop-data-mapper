...
GO
/****** Object:  Table [cdm].[vocabulary]    Script Date: 30/01/2024 09:25:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[cdm].[vocabulary]') AND type in (N'U'))
DROP TABLE [cdm].[vocabulary]
GO
/****** Object:  Table [cdm].[visit_occurrence]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[visit_detail]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[specimen]    Script Date: 30/01/2024 09:25:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[cdm].[specimen]') AND type in (N'U'))
DROP TABLE [cdm].[specimen]
GO
/****** Object:  Table [cdm].[source_to_concept_map]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[relationship]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[provider]    Script Date: 30/01/2024 09:25:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[cdm].[provider]') AND type in (N'U'))
DROP TABLE [cdm].[provider]
GO
/****** Object:  Table [cdm].[procedure_occurrence]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[person]    Script Date: 30/01/2024 09:25:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[cdm].[person]') AND type in (N'U'))
DROP TABLE [cdm].[person]
GO
/****** Object:  Table [cdm].[payer_plan_period]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[observation_period]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[episode_event]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[episode]    Script Date: 30/01/2024 09:25:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[cdm].[episode]') AND type in (N'U'))
DROP TABLE [cdm].[episode]
GO
/****** Object:  Table [cdm].[drug_strength]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[drug_exposure]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[condition_era]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[concept_synonym]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[concept_relationship]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[concept_class]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[concept_ancestor]    Script Date: 30/01/2024 09:25:06 ******/
...
GO
/****** Object:  Table [cdm].[concept]    Script Date: 30/01/2024 09:25:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[cdm].[concept]') AND type in (N'U'))
DROP TABLE [cdm].[concept]
GO
/****** Object:  Table [cdm].[cohort_definition]    Script Date: 30/01/2024 09:25:06 ******/
...
CREATE TABLE [cdm].[visit_detail](
	[visit_detail_id] [int] NOT NULL identity,
	[person_id] [int] NOT NULL,
...
CREATE TABLE [cdm].[visit_occurrence](
	[visit_occurrence_id] [int] NOT NULL identity,
	[person_id] [int] NOT NULL,
