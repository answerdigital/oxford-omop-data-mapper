...
internal class SusOPReferralReceivedDateForOutpatients : OmopObservation<SusOPReferralReceivedDateForOutpatientsRecord>
{
    ...
    [CopyValue(nameof(Source.ReferralRequestReceivedDate))]
