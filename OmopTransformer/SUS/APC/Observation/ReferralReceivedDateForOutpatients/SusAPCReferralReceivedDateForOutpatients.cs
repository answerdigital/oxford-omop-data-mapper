...
internal class SusAPCReferralReceivedDateForOutpatients : OmopObservation<SusAPCReferralReceivedDateForOutpatientsRecord>
{
    ...
    [CopyValue(nameof(Source.ReferralToTreatmentPeriodStartDate))]
