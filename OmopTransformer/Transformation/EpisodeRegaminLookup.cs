...
internal class EpisodeRegimenLookup : ILookup
{
    public Dictionary<string, ValueWithNote> Mappings { get; } =
        new()
        {
            ...
            { "Pertuzumab Trastuzumab Docetaxel", new ValueWithNote("", "No mapping") },
            { "Carfilzomib Lenalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Epirubicin Oxaliplatin Fluorouracil", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab Paclitaxel albumin-bound", new ValueWithNote("", "No mapping") },
            { "Paclitaxel weekly Trastuzumab", new ValueWithNote("", "No mapping") },
            { "Mitomycin Capecitabine with concurrent RT", new ValueWithNote("", "No mapping") },
            { "Carfilzomib Pomalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Gemcitabine Paclitaxel albumin bound", new ValueWithNote("", "No mapping") },
            { "Bevacizumab (7.5mg/kg) Paclitaxel Carboplatin (CrCl)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Trastuzumab (TCH) CrCl", new ValueWithNote("", "No mapping") },
            { "Temozolomide", new ValueWithNote("", "No mapping") },
            { "Oxaliplatin Raltitrexed", new ValueWithNote("", "No mapping") },
            { "Afatinib", new ValueWithNote("", "No mapping") },
            { "Apalutamide", new ValueWithNote("", "No mapping") },
            { "Letrozole", new ValueWithNote("", "No mapping") },
            { "Paclitaxel albumin bound (support)", new ValueWithNote("", "No mapping") },
            { "Atezolizumab Paclitaxel albumin-bound", new ValueWithNote("", "No mapping") },
            { "Bevacizumab (15mg/kg) Paclitaxel Carboplatin (CrCl)", new ValueWithNote("", "No mapping") },
            { "Carboplatin Etoposide Ifosfamide (CarboPEI)", new ValueWithNote("", "No mapping") },
            { "FOLFOXIRI", new ValueWithNote("", "No mapping") },
            { "Carboplatin Capecitabine + RT (CrCl)", new ValueWithNote("", "No mapping") },
            { "Vinorelbine PO (60) Carboplatin AUC5 (CrCl)", new ValueWithNote("", "No mapping") },
            { "Raltitrexed Oxaliplatin", new ValueWithNote("", "No mapping") },
            { "Docetaxel", new ValueWithNote("", "No mapping") },
            { "FLAG-IDA Venetoclax", new ValueWithNote("", "No mapping") },
            { "Dacarbazine (melanoma)", new ValueWithNote("", "No mapping") },
            { "Exemestane", new ValueWithNote("", "No mapping") },
            { "Sunitinib", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Pertuzumab Trastuzumab (adjuvant)", new ValueWithNote("", "No mapping") },
            { "EC Paclitaxel (dose dense)", new ValueWithNote("", "No mapping") },
            { "Vinorelbine PO (60-80) Cisplatin Daypt", new ValueWithNote("", "No mapping") },
            { "Palbociclib (aromatase inhibitor)", new ValueWithNote("", "No mapping") },
            { "Liposomal doxorubicin", new ValueWithNote("", "No mapping") },
            { "Ponatinib", new ValueWithNote("", "No mapping") },
            { "Paclitaxel (weekly for 3 weeks then 1 week off) Trastuzumab", new ValueWithNote("", "No mapping") },
            { "Cabozantinib", new ValueWithNote("", "No mapping") },
            { "Irinotecan", new ValueWithNote("", "No mapping") },
            { "Dacarbazine (sarcoma)", new ValueWithNote("", "No mapping") },
            { "Nivolumab Oxaliplatin Capecitabine", new ValueWithNote("", "No mapping") },
            { "EC", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab Oxaliplatin Capecitabine", new ValueWithNote("", "No mapping") },
            { "Gemcitabine Paclitaxel albumin bound (support)", new ValueWithNote("", "No mapping") },
            { "Oxaliplatin Capecitabine (OX)", new ValueWithNote("", "No mapping") },
            { "Olaparib (compassionate use)", new ValueWithNote("", "No mapping") },
            { "PARTNER Olaparib (Trial)", new ValueWithNote("", "No mapping") },
            { "Eribulin", new ValueWithNote("", "No mapping") },
            { "Daratumumab Pomalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Bortezomib Thalidomide Dexamethasone (VTD) (28 day cycle)", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide Lenalidomide Dexamethasone (weekly cyclophosphamide)", new ValueWithNote("", "No mapping") },
            { "Cisplatin (60) Etoposide (120) (SCLC) Daypt", new ValueWithNote("", "No mapping") },
            { "Isatuximab Pomalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Zanubrutinib", new ValueWithNote("", "No mapping") },
            { "Olaparib (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "Methotrexate Mercaptopurine Indometacin", new ValueWithNote("", "No mapping") },
            { "Carboplatin Vinorelbine oral with concurrent RT (CrCl)", new ValueWithNote("", "No mapping") },
            { "Ifosfamide (3g) Doxorubicin (30mg) (sarcoma)", new ValueWithNote("", "No mapping") },
            { "Bortezomib Thalidomide Dexamethasone (VTD) (21 day cycle)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel (80) Carboplatin (AUC 2) (CrCl) weekly", new ValueWithNote("", "No mapping") },
            { "Acalabrutinib", new ValueWithNote("", "No mapping") },
            { "Bevacizumab Pembrolizumab Carboplatin Paclitaxel (CrCl)", new ValueWithNote("", "No mapping") },
            { "Pertuzumab Trastuzumab Docetaxel (metastatic)", new ValueWithNote("", "No mapping") },
            { "Ixazomib Lenalidomide Dexamethasone (named patient supply)", new ValueWithNote("", "No mapping") },
            { "Doxorubicin Cisplatin Cyclophosphamide (CAP)", new ValueWithNote("", "No mapping") },
            { "Epirubicin Oxaliplatin Capecitabine (EOX)", new ValueWithNote("", "No mapping") },
            { "Cisplatin (75) Etoposide (100) (SCLC) Daypt", new ValueWithNote("", "No mapping") },
            { "Quizartinib (compassionate use)", new ValueWithNote("", "No mapping") },
            { "Omeprazole", new ValueWithNote("", "No mapping") },
            { "Erlotinib", new ValueWithNote("", "No mapping") },
            { "IE/VC", new ValueWithNote("", "No mapping") },
            { "AMM cycles 5-6 MAP (off study)", new ValueWithNote("", "No mapping") },
            { "CCS1477-02 CCS1477-MB 4 days on 3 days off (Trial)", new ValueWithNote("", "No mapping") },
            { "75276617ALE1001 JNJ75276617 tablets (Trial)", new ValueWithNote("", "No mapping") },
            { "FLAMSA-BU >=60 years (off study)", new ValueWithNote("", "No mapping") },
            { "Ciprofloxacin for prophylaxis", new ValueWithNote("", "No mapping") },
            { "ACELARATE Acelarin infusion bag (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Lorazepam", new ValueWithNote("", "No mapping") },
            { "PlasmaMATCH Cohort E (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Pamidronate 30 28 day (support)", new ValueWithNote("", "No mapping") },
            { "RomiCar (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Oral cryotherapy", new ValueWithNote("", "No mapping") },
            { "CLARITY (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "ST101-101 ST101 expansion (Trial)", new ValueWithNote("", "No mapping") },
            { "Atropine sulphate", new ValueWithNote("", "No mapping") },
            { "Metoclopramide 14 day", new ValueWithNote("", "No mapping") },
            { "PIANO (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "RADAR Arm B A2VD (Trial)", new ValueWithNote("", "No mapping") },
            { "Colestyramine", new ValueWithNote("", "No mapping") },
            { "RP2-001-18 re-initiation of RP2 (Trial)", new ValueWithNote("", "No mapping") },
            { "Micafungin", new ValueWithNote("", "No mapping") },
            { "Fosaprepitant IV", new ValueWithNote("", "No mapping") },
            { "AIDA", new ValueWithNote("", "No mapping") },
            { "APMM 2 cycles (MAP) (off study)", new ValueWithNote("", "No mapping") },
            { "Loperamide", new ValueWithNote("", "No mapping") },
            { "RP2-001-18 re-initiation of RP2 (support) (Trial)", new ValueWithNote("", "No mapping") },
            { "LOGIC2; Run in (early phase trial)", new ValueWithNote("", "No mapping") },
            { "OVM-200-100 OVM-200 (Trial)", new ValueWithNote("", "No mapping") },
            { "Metoclopramide 28 day", new ValueWithNote("", "No mapping") },
            { "LATITUDE (NCRN 433) Open label extension phase (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Hydroxycarbamide initiation", new ValueWithNote("", "No mapping") },
            { "Magnesium support", new ValueWithNote("", "No mapping") },
            { "MOTION Vimseltinib (Trial)", new ValueWithNote("", "No mapping") },
            { "ROMAZA cohorts -2, -1, 1 and 2 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Anaphylaxis treatment", new ValueWithNote("", "No mapping") },
            { "NX-5948-301 NX-5948 (Trial)", new ValueWithNote("", "No mapping") },
            { "RPL-001-16 re-initiation (support) (Trial)", new ValueWithNote("", "No mapping") },
            { "Metoclopramide 7 day", new ValueWithNote("", "No mapping") },
            { "RXC004/0001 run in (Trial)", new ValueWithNote("", "No mapping") },
            { "Loratadine", new ValueWithNote("", "No mapping") },
            { "Cetirizine 28 days", new ValueWithNote("", "No mapping") },
            { "Cetirizine 7 days", new ValueWithNote("", "No mapping") },
            { "ATTAINMENT Module 1 MDX-124 (Trial)", new ValueWithNote("", "No mapping") },
            { "Ondansetron 12 days prn", new ValueWithNote("", "No mapping") },
            { "Movicol", new ValueWithNote("", "No mapping") },
            { "KEYNOTE-867 (MK3475-867) (Trial)", new ValueWithNote("", "No mapping") },
            { "Metoclopramide 3 day", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondanestron weekly cisplatin", new ValueWithNote("", "No mapping") },
            { "Pyridoxine 50mg", new ValueWithNote("", "No mapping") },
            { "Famotidine", new ValueWithNote("", "No mapping") },
            { "Euro Ewing 2012 IE/VC (off study)", new ValueWithNote("", "No mapping") },
            { "Aciclovir prophylaxis 200mg tds", new ValueWithNote("", "No mapping") },
            { "Entecavir", new ValueWithNote("", "No mapping") },
            { "Hydroxycarbamide", new ValueWithNote("", "No mapping") },
            { "Nystatin", new ValueWithNote("", "No mapping") },
            { "Palonosetron IV", new ValueWithNote("", "No mapping") },
            { "KEYNOTE-867 (MK3475-867-00) (Trial)", new ValueWithNote("", "No mapping") },
            { "Calcium carbonate Vitamin D", new ValueWithNote("", "No mapping") },
            { "Ibandronic acid", new ValueWithNote("", "No mapping") },
            { "Aciclovir-prophylaxis", new ValueWithNote("", "No mapping") },
            { "Ondansetron metoclopramide 1 day", new ValueWithNote("", "No mapping") },
            { "Ondansetron metoclopramide", new ValueWithNote("", "No mapping") },
            { "Furosemide PO 1 day", new ValueWithNote("", "No mapping") },
            { "Famotidine premed", new ValueWithNote("", "No mapping") },
            { "Ondansetron metoclopramide days 1, 8 and 15", new ValueWithNote("", "No mapping") },
            { "ALL Maintenance (25-60 years)", new ValueWithNote("", "No mapping") },
            { "RP3-301 RP3 (support) (Trial)", new ValueWithNote("", "No mapping") },
            { "Levofloxacin prophylaxis 28 days", new ValueWithNote("", "No mapping") },
            { "CEDAR Enadenotucirev loading (Trial)", new ValueWithNote("", "No mapping") },
            { "Dexrazoxane (cardiotoxicity)", new ValueWithNote("", "No mapping") },
            { "ANIMATE (CA209-445) (Trial)", new ValueWithNote("", "No mapping") },
            { "Low emetic risk prochlorperazine", new ValueWithNote("", "No mapping") },
            { "Sodium chloride 0.9% IV ambulatory infusor", new ValueWithNote("", "No mapping") },
            { "Epaderm Emollient", new ValueWithNote("", "No mapping") },
            { "Fluconazole prophylaxis", new ValueWithNote("", "No mapping") },
            { "Ondansetron metoclopramide 5 days", new ValueWithNote("", "No mapping") },
            { "PICC line pack", new ValueWithNote("", "No mapping") },
            { "MUK nine b RD (SC) maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "Cyclizine", new ValueWithNote("", "No mapping") },
            { "COMICE (Trial)", new ValueWithNote("", "No mapping") },
            { "High emetic rsk ondansetron metoclopramide days 1, 8 and 15", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron metoclopramide 5 days", new ValueWithNote("", "No mapping") },
            { "Lorazepam daily", new ValueWithNote("", "No mapping") },
            { "Olanzapine", new ValueWithNote("", "No mapping") },
            { "Rasburicase", new ValueWithNote("", "No mapping") },
            { "Ondansetron day 1 oral premedication", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron metoclopramide 5 days", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron 1 day", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron liquids 1 day", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron 3.5 days", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron 5 days", new ValueWithNote("", "No mapping") },
            { "Darbepoeitin weekly", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron 1.5 days", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron 5 days", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron 2 days", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron 1.5 days", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron 1 day", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron 1 day weekly", new ValueWithNote("", "No mapping") },
            { "Paracetamol soluble", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron metoclopramide 1 day", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron metoclopramide days 1, 8 and 15", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron 3 days", new ValueWithNote("", "No mapping") },
            { "Low emetic risk domperidone", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron metoclopramide 1 day", new ValueWithNote("", "No mapping") },
            { "Colesevelam", new ValueWithNote("", "No mapping") },
            { "Moderate emetic risk ondansetron liquids", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron liquids", new ValueWithNote("", "No mapping") },
            { "High emetic risk ondansetron days 1, 8 and 15", new ValueWithNote("", "No mapping") },
            { "AMADEUS (Trial)", new ValueWithNote("", "No mapping") },
            { "Diprobase", new ValueWithNote("", "No mapping") },
            { "Mesna IV", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab 21 day then 42 day (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "ACCEPT Phase 1 cohort 2 and phase 2 cycles 1-6 (Trial)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 302 NUFIRI Q1W (Trial)", new ValueWithNote("", "No mapping") },
            { "Liposomal amphotericin B (Ambisome) prophylaxis", new ValueWithNote("", "No mapping") },
            { "ONC001 Part A1 cohort 4 (4 weekly) (Trial)", new ValueWithNote("", "No mapping") },
            { "DREAMM-9 Belantamab mafodontin VRd (every cycle) (Trial)", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen B1/C1 maintenance (males) (off study)", new ValueWithNote("", "No mapping") },
            { "CC-92480-MM-001 21/28 OD schedule (Trial)", new ValueWithNote("", "No mapping") },
            { "DREAMM-9 Belantamab mafodontin Rd maintenance (every cycle) (Trial)", new ValueWithNote("", "No mapping") },
            { "Difflam", new ValueWithNote("", "No mapping") },
            { "RP2-001-18 RP2 (Trial)", new ValueWithNote("", "No mapping") },
            { "Posaconazole prophylaxis", new ValueWithNote("", "No mapping") },
            { "Sodium chloride 0.9% IV (Venetoclax hydration)", new ValueWithNote("", "No mapping") },
            { "Sodium chloride 0.9% 500ml IV infusion", new ValueWithNote("", "No mapping") },
            { "75276617ALE1001 JNJ75276617 capsules (Trial)", new ValueWithNote("", "No mapping") },
            { "Ferinject 1000mg IVI", new ValueWithNote("", "No mapping") },
            { "Paracetamol oral", new ValueWithNote("", "No mapping") },
            { "Hydroxycarbamide (alternate day dosing)", new ValueWithNote("", "No mapping") },
            { "Stem cells", new ValueWithNote("", "No mapping") },
            { "Methylene blue", new ValueWithNote("", "No mapping") },
            { "TIMEPOINT (MNA-3521-012) MTL-CEBPA Pembrolizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "CANC3947 TITAN Open label (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "TALAPRO-2 (C3441021) part 2 (Trial)", new ValueWithNote("", "No mapping") },
            { "Pamidronate 30 28 day", new ValueWithNote("", "No mapping") },
            { "PEACOCC (Trial)", new ValueWithNote("", "No mapping") },
            { "ARCADIAN Atovaquone (Trial)", new ValueWithNote("", "No mapping") },
            { "Calcium levofolinate 175mg", new ValueWithNote("", "No mapping") },
            { "EORTC-HGUS 62113-55115 (Trial)", new ValueWithNote("", "No mapping") },
            { "IMP-MEL IMM60 (Trial)", new ValueWithNote("", "No mapping") },
            { "Sodium chloride IV infusion", new ValueWithNote("", "No mapping") },
            { "WINGMEN Xentuzumab (Trial)", new ValueWithNote("", "No mapping") },
            { "OCTOVA Arm C (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "ALL Intensification / CNS prophylaxis (25-60 years)", new ValueWithNote("", "No mapping") },
            { "ALL Consolidation cycle 3 days 29-42 (25-60 years)", new ValueWithNote("", "No mapping") },
            { "1480-0001 (IV STING) BI 1703880 Ezabenlimab (Trial)", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab 21 day (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "STP938-101 STP938 (Trial)", new ValueWithNote("", "No mapping") },
            { "Codeine Phosphate po", new ValueWithNote("", "No mapping") },
            { "IMG-7289-CTP-102 IMG-7289 (Trial)", new ValueWithNote("", "No mapping") },
            { "Potassium chloride 20mmol IV", new ValueWithNote("", "No mapping") },
            { "Rituximab weekly (ITP)", new ValueWithNote("", "No mapping") },
            { "Lamivudine", new ValueWithNote("", "No mapping") },
            { "Levomepromazine", new ValueWithNote("", "No mapping") },
            { "DREAMM-9 Belantamab mafodontin Rd maintenance (every 3rd cycle) (Trial)", new ValueWithNote("", "No mapping") },
            { "RMS 2005 IVADo cycles 1-3 (off study)", new ValueWithNote("", "No mapping") },
            { "Chlorphenamine 7 days", new ValueWithNote("", "No mapping") },
            { "ACE-CL-001 ACP-196 Cohort 2b (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Darbepoeitin 3 weekly", new ValueWithNote("", "No mapping") },
            { "MOTION Vismeltinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Azithromycin prophylaxis (250mg) 3 x week 28 day", new ValueWithNote("", "No mapping") },
            { "Atropine sulphate (5 days)", new ValueWithNote("", "No mapping") },
            { "Isoniazid", new ValueWithNote("", "No mapping") },
            { "Ranitidine premed IV", new ValueWithNote("", "No mapping") },
            { "Azithromycin prophylaxis (250mg) 3 x week 21 day", new ValueWithNote("", "No mapping") },
            { "Pentamidine prophylaxis IV", new ValueWithNote("", "No mapping") },
            { "EP 166/50 daypt", new ValueWithNote("", "No mapping") },
            { "BEP 3 day metastatic (NSCGT) daypt", new ValueWithNote("", "No mapping") },
            { "Magnesium sulphate 8mmol IV", new ValueWithNote("", "No mapping") },
            { "75276617ALE1001 JNJ75276617 (Trial)", new ValueWithNote("", "No mapping") },
            { "M16-191 Transform-1 (Trial)", new ValueWithNote("", "No mapping") },
            { "DREAMM-9 Belantamab mafodontin VRd (every 3rd cycle from cycle 4) (Trial)", new ValueWithNote("", "No mapping") },
            { "CCS1477-02 CCS1477 3 days on 4 days off (Trial)", new ValueWithNote("", "No mapping") },
            { "Cimetidine premed", new ValueWithNote("", "No mapping") },
            { "CC-92480-MM-001 20/28 schedule (Trial)", new ValueWithNote("", "No mapping") },
            { "Metoclopramide 21 day", new ValueWithNote("", "No mapping") },
            { "EORTC-HGUS 62113-55115 (open label) (Trial)", new ValueWithNote("", "No mapping") },
            { "ACE-CL-001 ACP-196 Cohort 8 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 302 NUFOX Q1W (Trial)", new ValueWithNote("", "No mapping") },
            { "RP3-301 RP3 (Trial)", new ValueWithNote("", "No mapping") },
            { "RATinG Lenzilumab (stage 1) (support) (Trial)", new ValueWithNote("", "No mapping") },
            { "CA290-841 (CONFIRM) (Trial)", new ValueWithNote("", "No mapping") },
            { "Magnesium sulphate 20mmol IV", new ValueWithNote("", "No mapping") },
            { "Ipi-Glio Arm A (Trial)", new ValueWithNote("", "No mapping") },
            { "Ondansetron for oral Vinorelbine days 1, 8 and 15", new ValueWithNote("", "No mapping") },
            { "CC-4047-MM-013 (Commercial trial)", new ValueWithNote("", "No mapping") },
            { "LUD2015-005 Post surgery Cohorts C and D (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "BEP 5 day metastatic (NSCGT) daypt", new ValueWithNote("", "No mapping") },
            { "RMS 2005 IVADo IVA cycles 4-9 (off study)", new ValueWithNote("", "No mapping") },
            { "Anaphylaxis prophylaxis", new ValueWithNote("", "No mapping") },
            { "STAMPEDE K SoC & Metformin (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "CEeDD SonoTran particles cohorts 1, 2B and 3B (Trial)", new ValueWithNote("", "No mapping") },
            { "D9571C00001 AZD7789 (Trial)", new ValueWithNote("", "No mapping") },
            { "Allopurinol for prevention of tumour lysis syndrome", new ValueWithNote("", "No mapping") },
            { "Aciclovir prophylaxis 200mg bd", new ValueWithNote("", "No mapping") },
            { "NX-1607-101 NX-1607 (Trial)", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen B Standard BFM consolidation (off study)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm A Maintenance (off study)", new ValueWithNote("", "No mapping") },
            { "MATTERHORN (D910GC00001) Durvalumab/placebo FLOT (Trial)", new ValueWithNote("", "No mapping") },
            { "MATRIX NLMT Arm J (Ceralasertib Durvalumab) (Trial)", new ValueWithNote("", "No mapping") },
            { "M16-109 (REFINE) Navitoclax monotherapy (Trial)", new ValueWithNote("", "No mapping") },
            { "Capecitabine (1250) adjuvant", new ValueWithNote("", "No mapping") },
            { "Rituximab 100mg dose (support)", new ValueWithNote("", "No mapping") },
            { "MonarchE Arm A Abemaciclib + SoC endocrine (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "KY1044-CT01 Atezolizumab KY1044 24mg infusion bag (Trial)", new ValueWithNote("", "No mapping") },
            { "Dexrazoxane", new ValueWithNote("", "No mapping") },
            { "STAR-221 Arm A Domvanalimab Zimberelimab FOLFOX (Trial)", new ValueWithNote("", "No mapping") },
            { "Capecitabine Phesgo SC (metastatic)", new ValueWithNote("", "No mapping") },
            { "CRUKD/22/002 HMBD-001 Arm 1 monotherapy (Trial)", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC (c1-3) then IV (c4-8) Bortezomib Dexam (neuropathy 21d) (compas)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm D Consolidation 1 (off study)", new ValueWithNote("", "No mapping") },
            { "VDTPACE (cyclophosphamide bolus)", new ValueWithNote("", "No mapping") },
            { "AML19 Cytarabine high dose (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "GCSF filgrastim", new ValueWithNote("", "No mapping") },
            { "NG-641-03 (NEBULA) NG-641 Nivolumab (Trial)", new ValueWithNote("", "No mapping") },
            { "RPL-001-16 Phase 1 expansion or Phase 2 Nivolumab & RP1 (Trial)", new ValueWithNote("", "No mapping") },
            { "Bendamustine 90-R (NHL)", new ValueWithNote("", "No mapping") },
            { "ALL Consolidation cycle 2 (25-60 years)", new ValueWithNote("", "No mapping") },
            { "5F9005 Magrolimab Azacitidine AML/MDS expansion (Trial)", new ValueWithNote("", "No mapping") },
            { "STAMPEDE G HT + Abiraterone (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Co-trimoxazole 480mg 3xweekly", new ValueWithNote("", "No mapping") },
            { "D933LC00001 (BEGONIA) Arm 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "PRIME-RT Arm A (Trial)", new ValueWithNote("", "No mapping") },
            { "Cisplatin 21 day (ovarian) daypt", new ValueWithNote("", "No mapping") },
            { "CT7001-001 Module 1 Cycle 1 onwards (Trial)", new ValueWithNote("", "No mapping") },
            { "Imatinib CML (support)", new ValueWithNote("", "No mapping") },
            { "ADCT-402-201 (Trial)", new ValueWithNote("", "No mapping") },
            { "ACE-536-MDS-002 (COMMANDS) Epoetin alfa (Trial)", new ValueWithNote("", "No mapping") },
            { "ACE-536-MF-001 (Trial)", new ValueWithNote("", "No mapping") },
            { "KRT-232-101 28 day cycle (Trial)", new ValueWithNote("", "No mapping") },
            { "MEDI4736-NHL-001 Arm B (NHL) (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "D933LC00001 (BEGONIA) Arm 2 (Trial)", new ValueWithNote("", "No mapping") },
            { "GS-US-546-5920 Cohort 2 Mag+MEC (Trial)", new ValueWithNote("", "No mapping") },
            { "Aprepitant with dexamethasone (day 1 on ward)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm C Maintenance (Off Study)", new ValueWithNote("", "No mapping") },
            { "PETReA Obintuzumab maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (CLL) (support)", new ValueWithNote("", "No mapping") },
            { "ALL Consolidation cycle 4 (25-60 years)", new ValueWithNote("", "No mapping") },
            { "STAR-221 Arm B Nivolumab FOLFOX (Trial)", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab 200mg (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "CA017-078 Nivolumab BMS-986205/Placebo adjuvant (Trial)", new ValueWithNote("", "No mapping") },
            { "Aprepitant with dexamethasone (day 1 at home)", new ValueWithNote("", "No mapping") },
            { "D933LC00001 (BEGONIA) Arm 6 (Trial)", new ValueWithNote("", "No mapping") },
            { "Methotrexate 50 (germ cell)", new ValueWithNote("", "No mapping") },
            { "Lansoprazole", new ValueWithNote("", "No mapping") },
            { "RADAR (Myeloma XV) RCyBorD induction (Trial)", new ValueWithNote("", "No mapping") },
            { "CEDAR Capecitabine RT Enadenotucirev maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "PEMBROWM Pembrolizumab Rituximab (Trial)", new ValueWithNote("", "No mapping") },
            { "ONC001 Part A or Part A1 cohorts 1 and 2 (2 weekly) (Trial)", new ValueWithNote("", "No mapping") },
            { "RP3-301 RP3 Nivolumab cohorts 1 and 5 (Trial)", new ValueWithNote("", "No mapping") },
            { "MUK nine b VRDd consolidation part 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen B3/C3 maintenance (males) (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "MITHRIDATE (RG_16-148) Ruxolitinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Cisplatin hydration (cisplatin dose >=61mg/m2)", new ValueWithNote("", "No mapping") },
            { "ONC001 Part A1 cohort 3 (3 weekly) (Trial)", new ValueWithNote("", "No mapping") },
            { "CCS1477-02 CCS1477-MB 4 days on 3 days off bd dosing (without azoles) (Trial)", new ValueWithNote("", "No mapping") },
            { "ACCEPT Phase 1 cohort 2 and phase 2 cycles 7-8 (Trial)", new ValueWithNote("", "No mapping") },
            { "D8231C00001 AZD4573 cycle 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "CC-90009-AML-001 Gen 2 days 1-10 (Trial)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (Mantle cell lymphoma) 2nd line", new ValueWithNote("", "No mapping") },
            { "Atezolizumab 21 day (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "GCSF pegfilgrastim", new ValueWithNote("", "No mapping") },
            { "RAMPART Arm C (Trial)", new ValueWithNote("", "No mapping") },
            { "GS-US-546-5920 Cohort 1 Mag+Ven+Aza (Trial)", new ValueWithNote("", "No mapping") },
            { "D933LC00001 (BEGONIA) Arm 5 (Trial)", new ValueWithNote("", "No mapping") },
            { "RMS 2005 Vinorelbine Cyclophosphamide maintenance (Off  Study)", new ValueWithNote("", "No mapping") },
            { "Fludarabine Melphalan RIC (Allograft)", new ValueWithNote("", "No mapping") },
            { "Denosumab (metastases) 6 weekly", new ValueWithNote("", "No mapping") },
            { "Rituximab IV 375mg/m2", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Phesgo SC (neoadjuvant node negative / unknown)", new ValueWithNote("", "No mapping") },
            { "Bendamustine 90-R firstline (CLL)", new ValueWithNote("", "No mapping") },
            { "Carboplatin desensitisation (CrCl) (support)", new ValueWithNote("", "No mapping") },
            { "Aprepitant without dexamethasone (day 1 on ward)", new ValueWithNote("", "No mapping") },
            { "Aspirin 75", new ValueWithNote("", "No mapping") },
            { "AML19 FLAG-Ida course 2 standard risk (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Nivolumab Oxaliplatin Modified de Gramont (EAMS)", new ValueWithNote("", "No mapping") },
            { "LOXO-BTK-20022 Arm B Venetoclax Rituximab cycle 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "Majic Ruxolitinib PV (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "TRIZELL rAd-IFN-MM-301 rAd-IFN Celecoxib (Trial)", new ValueWithNote("", "No mapping") },
            { "Add Aspirin randomised trial treatment (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Doxorubicin (urgent use)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm A Consolidation (off study)", new ValueWithNote("", "No mapping") },
            { "ENHANCE (5F9009) Magrolimab / placebo Azacitidine (Trial)", new ValueWithNote("", "No mapping") },
            { "Carboplatin desensitisation (CrCl)", new ValueWithNote("", "No mapping") },
            { "LOXO-BTK-20022 Arm B Venetoclax Rituximab cycles 2-25 (Trial)", new ValueWithNote("", "No mapping") },
            { "Trastuzumab IV", new ValueWithNote("", "No mapping") },
            { "Cetuximab Oxaliplatin Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "ACTICCA-1 Gemcitabine Cisplatin (Trial)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm D Phase 1 and 2 Induction (off study)", new ValueWithNote("", "No mapping") },
            { "Melphalan high dose (Autograft) (renal impairment)", new ValueWithNote("", "No mapping") },
            { "Carboplatin AUC 5 (EDTA)", new ValueWithNote("", "No mapping") },
            { "ISIS-702843-CS4 Cohort A (Trial)", new ValueWithNote("", "No mapping") },
            { "INITIUM (UV1-202) UV1 Ipilimumab Nivolumab (Trial)", new ValueWithNote("", "No mapping") },
            { "FGCL-4592-082 Roxadustat / placebo (Trial)", new ValueWithNote("", "No mapping") },
            { "CABL001J12301 Arm 2 Imatinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib Rituximab (IV cycle 1 then SC c2-6) (Mantle cell lymphoma) 1st line", new ValueWithNote("", "No mapping") },
            { "PCYC-1128-CA Cohort 5 Ibrutinib (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "PROSPER Enzalutamide open label (commercial trial)", new ValueWithNote("", "No mapping") },
            { "PRISM (ACE-LY-111) Arm 1 Acalabrutinib AZD9150 (Trial)", new ValueWithNote("", "No mapping") },
            { "R3767-ONC-1613 REGN3767 and REGN2810 combination (Trial)", new ValueWithNote("", "No mapping") },
            { "1426-0001 Arm B BI 138746 BI 754091 (Trial)", new ValueWithNote("", "No mapping") },
            { "Intrathecal Methotrexate", new ValueWithNote("", "No mapping") },
            { "Belantamab mafodontin (GSK2857916) (compassionate use)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 302 Bevacizumab (support) (Trial)", new ValueWithNote("", "No mapping") },
            { "RiVa Arm B (Trial)", new ValueWithNote("", "No mapping") },
            { "Nivolumab 14 day", new ValueWithNote("", "No mapping") },
            { "NUTIDE 701 NUC-7738 Pembrolizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Cisplatin hydration (cisplatin dose =<40mg/m2)", new ValueWithNote("", "No mapping") },
            { "CA017-078 Gemcitabine Cisplatin Nivolumab BMS-986205/Placebo (Trial)", new ValueWithNote("", "No mapping") },
            { "FLAIR Fludarabine Cyclophosphamide Rituximab (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Phesgo (Pertuzumab with Trastuzumab) SC (metastatic)", new ValueWithNote("", "No mapping") },
            { "PRO-DLI (Fludarabine Melphalan Alemtuzumab) (Trial)", new ValueWithNote("", "No mapping") },
            { "Carboplatin AUC 7 (CrCl)", new ValueWithNote("", "No mapping") },
            { "Denosumab (metastases) 4 weekly (84 day cycle)", new ValueWithNote("", "No mapping") },
            { "BEACOPDac escalated", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen C Capizzi interim maintenance (off study)", new ValueWithNote("", "No mapping") },
            { "Docetaxel (100) (adjuvant) 21 day", new ValueWithNote("", "No mapping") },
            { "Irinotecan Modified DeGramont (NET)", new ValueWithNote("", "No mapping") },
            { "ATRA (Tretinoin) (emergency use continuation) support", new ValueWithNote("", "No mapping") },
            { "D8231C00001 AZD4573 cycle 2 onwards (Trial)", new ValueWithNote("", "No mapping") },
            { "CDK-002-101 (Trial)", new ValueWithNote("", "No mapping") },
            { "Constellation (0610-02) Arms 2 and 3 CPI-610 Ruxolitinib (Trial)", new ValueWithNote("", "No mapping") },
            { "CRUKD/11/001;Vandeta+Selumetinib(od)dose escalation_C2onwards (EarlyPhaseTrial)", new ValueWithNote("", "No mapping") },
            { "Erythropoietin zeta weekly", new ValueWithNote("", "No mapping") },
            { "Carboplatin 21 day (CrCl) breast", new ValueWithNote("", "No mapping") },
            { "Imatinib (GIST)", new ValueWithNote("", "No mapping") },
            { "Nivolumab Oxaliplatin Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "CO41942 Mosun+Len Mosunetuzumab Lenalidomide cycles 2-12 (Trial)", new ValueWithNote("", "No mapping") },
            { "CA017-078 Gemcitabine Cisplatin (Trial)", new ValueWithNote("", "No mapping") },
            { "Cetuximab 2 weekly combination (support)", new ValueWithNote("", "No mapping") },
            { "ENRICH Ibrutinib additional (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Irinotecan Capecitabine 21 day", new ValueWithNote("", "No mapping") },
            { "UPSTREAM (EORTC1559) Durvalumab Monalizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre docetaxel 16mg IV 1 day", new ValueWithNote("", "No mapping") },
            { "Denosumab (metastases) 4 weekly", new ValueWithNote("", "No mapping") },
            { "LOXO-BTK-20019 Arm B Ibrutinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Constellation (0610-02) Arm 4 CPI-0610 monotherapy (Trial)", new ValueWithNote("", "No mapping") },
            { "CA224048 Relatlimab Nivolumab Ipilimumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Phesgo (Pertuzumab with Trastuzumab) SC (adjuvant) (support)", new ValueWithNote("", "No mapping") },
            { "REMoDL-A Acalabrutinib R-CHOP cycles 2-6 (Trial)", new ValueWithNote("", "No mapping") },
            { "PROMise PLX2853 Ruxolitinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre docetaxel 20mg IV 1 day", new ValueWithNote("", "No mapping") },
            { "FLA-IDA", new ValueWithNote("", "No mapping") },
            { "LOXO-BTK-20022 Arm A Pirtobrutinib Venetoclax Rituximab (Trial)", new ValueWithNote("", "No mapping") },
            { "CNIS793B12301 (dANIS-2) NIS793/placebo Gemcitabine Nab-paclitaxel (Trial)", new ValueWithNote("", "No mapping") },
            { "5F9003 Hu5F9-G4 + R-GemOx cycle 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (lymphoma) (compassionate use)", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen C Delayed intensification (off study)", new ValueWithNote("", "No mapping") },
            { "CABL001E2201 Imatinib arm (Trial)", new ValueWithNote("", "No mapping") },
            { "daNIS-3 NIS793 FOLFIRI Bevacizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Phesgo SC (neoadjuvant node positive)", new ValueWithNote("", "No mapping") },
            { "Imatinib ALL (support)", new ValueWithNote("", "No mapping") },
            { "TRIZELL rAd-IFN-MM-301 Gemcitabine (Trial)", new ValueWithNote("", "No mapping") },
            { "CC-4047-MM-007 (CANC4276) Bortezomib Dexamethasone Pomalidomide (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Carboplatin 21 day (EDTA)", new ValueWithNote("", "No mapping") },
            { "Daratumumab Bortezomib Dexamethasone (cycle 9 onwards) (28 day) rapid rate", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre/post docetaxel 8mg po weekly prostate", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide priming prior to PBSC harvest", new ValueWithNote("", "No mapping") },
            { "Irinotecan Oxaliplatin Modified de Gramont modified (neoadjuvant)", new ValueWithNote("", "No mapping") },
            { "APHRODITE Capecitabine (Trial)", new ValueWithNote("", "No mapping") },
            { "FEDORA (RG_21-109) Fedratinib Ropeginterferon alfa-2b (Trial)", new ValueWithNote("", "No mapping") },
            { "Panitumumab Irinotecan Modified DeGramont", new ValueWithNote("", "No mapping") },
            { "Irinotecan Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "Enzalutamide (metastatic hormone relapsed)", new ValueWithNote("", "No mapping") },
            { "Methotrexate weekly (Large granular cell leukaemia)", new ValueWithNote("", "No mapping") },
            { "Imatinib 400-600", new ValueWithNote("", "No mapping") },
            { "STELLAR CHOP-R Acalabrutinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Carboplatin VTDPACE (support)", new ValueWithNote("", "No mapping") },
            { "Daratumumab Bortezomib Dexamethasone (neuropathy) (cycles 1 to 8 only) (21 day)", new ValueWithNote("", "No mapping") },
            { "CO41942 Mosun+Len Mosunetuzumab SC Lenalidomide cycle 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "CO41942 Mosun+Len Mosunetuzumab SC Lenalidomide cycles 2-12 (Trial)", new ValueWithNote("", "No mapping") },
            { "Denosumab (metastases) 12 weekly", new ValueWithNote("", "No mapping") },
            { "Bortezomib (TTP)", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre/post docetaxel 20mg IV 8mg po 3 day (RBFT)", new ValueWithNote("", "No mapping") },
            { "CT7001-001 Module 2 part A (Trial)", new ValueWithNote("", "No mapping") },
            { "Mesna for cyclophosphamide 750", new ValueWithNote("", "No mapping") },
            { "ALL Phase 1 Induction (25-60 years)", new ValueWithNote("", "No mapping") },
            { "Rituximab SC maintenance 2nd remission only (3 monthly) (Lymphoma)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm A Phase 1 and 2 induction (off study)", new ValueWithNote("", "No mapping") },
            { "Trastuzumab SC (support)", new ValueWithNote("", "No mapping") },
            { "EXCALIBER-RRMM (CC-220-MM-002) Arm A (Trial)", new ValueWithNote("", "No mapping") },
            { "Aprepitant without dexamethasone (day 1 at home)", new ValueWithNote("", "No mapping") },
            { "InterAACT Carboplatin Paclitaxel (CrCl) (off study)", new ValueWithNote("", "No mapping") },
            { "Daratumumab Bortezomib Dexamethasone (neuropathy) (cycles 1 to 8 only) 21 rapid", new ValueWithNote("", "No mapping") },
            { "Ondansetron temozolomide 5 day", new ValueWithNote("", "No mapping") },
            { "KY1044-CT01 Atezolizumab KY1044 (Trial)", new ValueWithNote("", "No mapping") },
            { "PETReA Rituximab SC Lenalidomide maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "Mitotane (Lysodren)", new ValueWithNote("", "No mapping") },
            { "Irinotecan Oxaliplatin Modified de Gramont (metastatic)", new ValueWithNote("", "No mapping") },
            { "ALL Phase 2 Induction (25-60 years)", new ValueWithNote("", "No mapping") },
            { "ACTICCA-1 Capecitabine (Trial)", new ValueWithNote("", "No mapping") },
            { "Carboplatin AUC 10 (CrCl)", new ValueWithNote("", "No mapping") },
            { "Carboplatin AUC 5 (CrCl)", new ValueWithNote("", "No mapping") },
            { "Rituximab SC maintenance 1st remission only (2 monthly) (Lymphoma)", new ValueWithNote("", "No mapping") },
            { "CA224048 Relatlimab Nivolumab BMS-986205 (Trial)", new ValueWithNote("", "No mapping") },
            { "AC (sarcoma)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (Waldenstrom’s macroglobulinaemia)", new ValueWithNote("", "No mapping") },
            { "Midostaurin (mastocytosis)", new ValueWithNote("", "No mapping") },
            { "COSI Mini Thiotepa Busulphan Fludarabine ATG (mini TBF) (Trial)", new ValueWithNote("", "No mapping") },
            { "Capecitabine (1250) metastatic", new ValueWithNote("", "No mapping") },
            { "Rituximab SC maintenance 1st remission only (2 monthly)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (Mantle cell lymphoma)", new ValueWithNote("", "No mapping") },
            { "Cisplatin Imatinib", new ValueWithNote("", "No mapping") },
            { "ENRICH Rituximab SC maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "Docetaxel (75) (metastatic) 21 day", new ValueWithNote("", "No mapping") },
            { "SCOPE 2 Capecitabine Cisplatin cycles 2-4 Arms 2 and 4 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "1426-0001 Arm A BI 1387446 (Trial)", new ValueWithNote("", "No mapping") },
            { "Mitomycin Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "Idarubicin IV (support)", new ValueWithNote("", "No mapping") },
            { "RAMPART Arm B (Trial)", new ValueWithNote("", "No mapping") },
            { "CTD (weekly cyclophosphamide)", new ValueWithNote("", "No mapping") },
            { "AGI-134.FIM.101 Monotherapy treatment (Trial)", new ValueWithNote("", "No mapping") },
            { "Panitumumab Oxaliplatin Modified DeGramont", new ValueWithNote("", "No mapping") },
            { "Omeprazole 5 day", new ValueWithNote("", "No mapping") },
            { "Carboplatin 21 day (CrCl)", new ValueWithNote("", "No mapping") },
            { "GRN163LMYF3001  Arm A Imetelstat (Trial)", new ValueWithNote("", "No mapping") },
            { "ENRICH Ibrutinib Rituximab SC maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 302 Arm 2A NUC-3373 weekly Oxaliplatin (Trial)", new ValueWithNote("", "No mapping") },
            { "COPELIA Arm 2 Cediranib Paclitaxel (Trial)", new ValueWithNote("", "No mapping") },
            { "Fludarabine Cyclophosphamide Rituximab CLL (Flu-Cy-R) (Oral)", new ValueWithNote("", "No mapping") },
            { "Panitumumab Oxaliplatin Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "VTDPACE (cyclophosphamide bolus)", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre/post docetaxel 8mg po 3 day", new ValueWithNote("", "No mapping") },
            { "ENRICH Ibrutinib Rituximab SC maintenance (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Phesgo SC (metastatic)", new ValueWithNote("", "No mapping") },
            { "FCiST Streptozocin Cisplatin Fluorouracil (Neuroendocrine) inpt", new ValueWithNote("", "No mapping") },
            { "Cabozantinib (RCC) (MAP)", new ValueWithNote("", "No mapping") },
            { "PARTNER AZD6738 Durvalumab (PARTNERING) (Trial)", new ValueWithNote("", "No mapping") },
            { "ENRICH Rituximab SC maintenance (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Phesgo SC (neoadjuvant node positive) CrCl", new ValueWithNote("", "No mapping") },
            { "Capecitabine (1250) (biliary tract)", new ValueWithNote("", "No mapping") },
            { "Etoposide IV (HLH)", new ValueWithNote("", "No mapping") },
            { "PARTNER FEC100 (Trial)", new ValueWithNote("", "No mapping") },
            { "RAINBOW Dexamethasone Cyclophosphamide Rituximab (Trial)", new ValueWithNote("", "No mapping") },
            { "COPELIA Arm 3 Olaparib Cediranib (Trial)", new ValueWithNote("", "No mapping") },
            { "Imatinib (GIST/sarcomas)", new ValueWithNote("", "No mapping") },
            { "AG946-C-002 Phase 2a (Trial)", new ValueWithNote("", "No mapping") },
            { "Temozolomide 150/200 (astrocytoma)", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen B Induction standard dexamethasone (off study)", new ValueWithNote("", "No mapping") },
            { "Obinutuzumab CVP", new ValueWithNote("", "No mapping") },
            { "CO41942 Mosun+Len Mosunetuzumab Lenalidomide cycle 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "PCYC-1116-CA; Ibrutinib (commercial trial)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (CLL)", new ValueWithNote("", "No mapping") },
            { "Ibrutinib (Waldenstrom�s macroglobulinaemia)", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC Bortezomib Dexamethasone (cycles 1 to 8 only) (21 day)", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre/post docetaxel 4mg po 3 day", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide Fludarabine TBI FIC (MUD transplant/cord cells)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 302 Arm 2B NUC-3373 weekly Irinotecan (Trial)", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC Bortezomib Dexamethasone (cycle 9 onwards) (28 day)", new ValueWithNote("", "No mapping") },
            { "Constellation (0610-02) Arm 1 CPI-0610 monotherapy (Trial)", new ValueWithNote("", "No mapping") },
            { "Trastuzumab Oxaliplatin Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "EC Capecitabine Daypt", new ValueWithNote("", "No mapping") },
            { "M14-239 Telisotuzumab vedotin (Trial)", new ValueWithNote("", "No mapping") },
            { "BI 1280.8 Arm A BI 836845 (1000mg) Enzalutamide (Trial)", new ValueWithNote("", "No mapping") },
            { "Irinotecan Modified DeGramont", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen B Delayed intensification (off study)", new ValueWithNote("", "No mapping") },
            { "CABL001A2001B Asciminib Imatinib arm (Trial)", new ValueWithNote("", "No mapping") },
            { "Daratumumab Bortezomib Dexamethasone (cycles 1 to 8 only) (21 day) rapid rate", new ValueWithNote("", "No mapping") },
            { "Bortezomib weekly Cyclophosphamide Dexamethasone (CyBorDex) (Amyloidosis)", new ValueWithNote("", "No mapping") },
            { "COSI Fludarabine Busulphan 4 (FB4) (Trial)", new ValueWithNote("", "No mapping") },
            { "Imatinib (sarcoma)", new ValueWithNote("", "No mapping") },
            { "CAR-T Fludarabine Cyclophosphamide Tisagenlecleucel (NHL)", new ValueWithNote("", "No mapping") },
            { "POD1UM-303 (InterAACT 2) INCMGA00012 / placebo Paclitaxel Carboplatin (Trial)", new ValueWithNote("", "No mapping") },
            { "PLATO Mitomycin Capecitabine 28 days (ACT4 or ACT5) (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Capecitabine (1000) breast", new ValueWithNote("", "No mapping") },
            { "R-CHOP-21 bolus", new ValueWithNote("", "No mapping") },
            { "PRIMUS 001 Paclitaxel albumin bound Gemcitabine (Trial)", new ValueWithNote("", "No mapping") },
            { "Chlorambucil-R (continuous)", new ValueWithNote("", "No mapping") },
            { "Chlorambucil-R (days 1 to 14)", new ValueWithNote("", "No mapping") },
            { "Methotrexate (50)", new ValueWithNote("", "No mapping") },
            { "Imatinib (CML)", new ValueWithNote("", "No mapping") },
            { "CABL001E2201 Asciminib 60mg Imatinib arm (Trial)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Pertuzumab Trastuzumab IV (adjuvant use only)", new ValueWithNote("", "No mapping") },
            { "Oxaliplatin Capecitabine 21 day", new ValueWithNote("", "No mapping") },
            { "ATOMIC-MESO (POLARIS 2015-003) ADI-PEG/Placebo Cisplatin Pemetrexed (Trial)", new ValueWithNote("", "No mapping") },
            { "Gemtuzumab Daunorubicin Cytarabine induction", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide TBI Alemtuzumab (MUD transplant)", new ValueWithNote("", "No mapping") },
            { "Vyxeos (Daunorubicin / Cytarabine) liposomal consolidation", new ValueWithNote("", "No mapping") },
            { "CABL001A2301 ABL001 arm (Trial)", new ValueWithNote("", "No mapping") },
            { "SCOPE 2 Carboplatin (CrCl) Paclitaxel cycles 2-4 Arms 1 and 3 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "UTX-TGR-205 Arm A Ublituximab TGR-1202 (Trial)", new ValueWithNote("", "No mapping") },
            { "ENRICH Bendamustine-R (Trial)", new ValueWithNote("", "No mapping") },
            { "Carmustine Thiotepa (High dose)", new ValueWithNote("", "No mapping") },
            { "CNIS793B12201 Arm 2 NIS793 Gemcitabine Nab-Paclitaxel (Trial)", new ValueWithNote("", "No mapping") },
            { "Enzalutamide (newly diagnosed metastatic)", new ValueWithNote("", "No mapping") },
            { "Cetuximab 2 weekly", new ValueWithNote("", "No mapping") },
            { "Cisplatin (support)", new ValueWithNote("", "No mapping") },
            { "CNIS793B12201 Arm 1 Spartalizumab NIS793 Gemcitabine Nab-Paclitaxel (Trial)", new ValueWithNote("", "No mapping") },
            { "SCOPE 2 Carboplatin (CrCl) Paclitaxel cycle 1 All patients (Trial)", new ValueWithNote("", "No mapping") },
            { "MoTD Fludarabine Melphalan experimental group 3 (Trial)", new ValueWithNote("", "No mapping") },
            { "MAGNETISMM-5 (C1071005) Arm C Daratumumab Pomalidomide Dexamethasone (Trial)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel Carboplatin 21 day (CrCl)", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre/post docetaxel 20mg IV 8mg po 2 day", new ValueWithNote("", "No mapping") },
            { "Dexamethasone pre/post docetaxel 20mg IV 8mg po 3 day", new ValueWithNote("", "No mapping") },
            { "ICON 9 Olaparib Cediranib Arm 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "Sunitinib (GIST)", new ValueWithNote("", "No mapping") },
            { "FLAIR Ibrutinib Venetoclax (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Abiraterone Prednisolone (support)", new ValueWithNote("", "No mapping") },
            { "Oxaliplatin Modified de Gramont", new ValueWithNote("", "No mapping") },
            { "Abiraterone Prednisolone (after at least 3 months of stable dose abiraterone)", new ValueWithNote("", "No mapping") },
            { "COSI Fludarabine Busulphan 2 (FB2) (Trial)", new ValueWithNote("", "No mapping") },
            { "daNIS-3 NIS793 Tislelizumab FOLFIRI Bevacizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Epirubicin (20) weekly", new ValueWithNote("", "No mapping") },
            { "SGN35-032 Brentuximab vedotin Cyclophosphamide Doxorubicin Prednisone (Trial)", new ValueWithNote("", "No mapping") },
            { "IMGN632-0802 Regimen C AZA+VEN+IMGN632 (Trial)", new ValueWithNote("", "No mapping") },
            { "Docetaxel (75) (NSCLC)", new ValueWithNote("", "No mapping") },
            { "Oxaliplatin Modified DeGramont", new ValueWithNote("", "No mapping") },
            { "SCOPE 2 Capecitabine Cisplatin cycle 1 All patients (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Omeprazole premed", new ValueWithNote("", "No mapping") },
            { "5F9003 Hu5F9-G4 Rituximab (Trial)", new ValueWithNote("", "No mapping") },
            { "Capecitabine (2000mg bd) 7/7", new ValueWithNote("", "No mapping") },
            { "Midostaurin Daunorubicin Cytarabine (cytarabine bolus DA)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine Dexamethasone Cisplatin (GDP) (Daypatient)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Phesgo SC (neoadjuvant node negative / unknown) CrCl", new ValueWithNote("", "No mapping") },
            { "FLAG Venetoclax", new ValueWithNote("", "No mapping") },
            { "BEAM Alemtuzumab (Allograft)", new ValueWithNote("", "No mapping") },
            { "CABL001E2201 Asciminib 40mg Imatinib arm (Trial)", new ValueWithNote("", "No mapping") },
            { "CompARE Arm 5 Cisplatin Durvalumab (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Capecitabine (1000)", new ValueWithNote("", "No mapping") },
            { "Olaparib capsules (400mg bd)", new ValueWithNote("", "No mapping") },
            { "IMC-F106C-101 IMC-F106C Paclitaxel albumin bound (Trial)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine Dexamethasone Cisplatin (GDP)", new ValueWithNote("", "No mapping") },
            { "ICE modified", new ValueWithNote("", "No mapping") },
            { "CAR-T Fludarabine Cyclophosphamide Axicabtagene ciloleucel", new ValueWithNote("", "No mapping") },
            { "EC Paclitaxel Carboplatin (CrCl)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Carboplatin (CrCl) (breast)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (pancreas)", new ValueWithNote("", "No mapping") },
            { "5F9005 Hu5F9-G4 Azacitidine evaluation (Trial)", new ValueWithNote("", "No mapping") },
            { "Cytarabine HD Rituximab", new ValueWithNote("", "No mapping") },
            { "Mitotane", new ValueWithNote("", "No mapping") },
            { "COSI Fludarabine Busulphan 2 (FB4) (off study)", new ValueWithNote("", "No mapping") },
            { "Sunitinib (pNET)", new ValueWithNote("", "No mapping") },
            { "OASIS II Arm B Ibrutinib Venetoclax Rituximab (Trial)", new ValueWithNote("", "No mapping") },
            { "MoTD Fludarabine Busulfan MF experimental group 3 (Trial)", new ValueWithNote("", "No mapping") },
            { "POMB/ACE", new ValueWithNote("", "No mapping") },
            { "R-VP", new ValueWithNote("", "No mapping") },
            { "Dasatinib (chronic phase CML)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Pertuzumab Trastuzumab IV (metastatic)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel albumin-bound Phesgo SC (metastatic)", new ValueWithNote("", "No mapping") },
            { "Daunorubicin liposomal Cytarabine liposomal (Vyxeos) induction", new ValueWithNote("", "No mapping") },
            { "IMC-F106C-101 IMC-F106C monotherapy (Trial)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Phesgo SC (adjuvant) CrCl", new ValueWithNote("", "No mapping") },
            { "Capecitabine (1250)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel weekly Carboplatin weekly (CrCl)", new ValueWithNote("", "No mapping") },
            { "Bevacizumab Paclitaxel Carboplatin 21 day (CrCl) (ovarian/fallopian/peritoneal)", new ValueWithNote("", "No mapping") },
            { "Isatuximab Pomalidomide Dexamethasone (EAMS)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Pertuzumab Trastuzumab IV(neoadjuvant node neg/unknown)Cr", new ValueWithNote("", "No mapping") },
            { "Vyxeos (Daunorubicin / Cytarabine) liposomal induction", new ValueWithNote("", "No mapping") },
            { "Paclitaxel Carboplatin EC (CrCl)", new ValueWithNote("", "No mapping") },
            { "Brentuximab vedotin Cyclophosphamide Doxorubicin Prednisolone (Bv-CHP)", new ValueWithNote("", "No mapping") },
            { "Thiotepa Fludarabine Treosulfan (Cord transplant)", new ValueWithNote("", "No mapping") },
            { "Chlorambucil-R (days 1 to 7)", new ValueWithNote("", "No mapping") },
            { "Ipilimumab Nivolumab (mesothelioma) (EAMS)", new ValueWithNote("", "No mapping") },
            { "Darolutamide Docetaxel Prednisolone (ORBIS)", new ValueWithNote("", "No mapping") },
            { "P+R-ICE Arm B Pembrolizumab R-ICE (Trial)", new ValueWithNote("", "No mapping") },
            { "Cemiplimab (support)", new ValueWithNote("", "No mapping") },
            { "ECF Daypt", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1200) Carboplatin (CrCl) (NSCLC/SCLC)", new ValueWithNote("", "No mapping") },
            { "Bendamustine-R Polatuzumab (not BMT candidate)", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Phesgo SC (adjuvant)", new ValueWithNote("", "No mapping") },
            { "ENRICH Bendamustine-R (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Temozolomide (brain) (support)", new ValueWithNote("", "No mapping") },
            { "Daunorubicin liposomal Cytarabine liposomal (Vyxeos) consolidation", new ValueWithNote("", "No mapping") },
            { "Doxorubicin Dexrazoxane", new ValueWithNote("", "No mapping") },
            { "GO42661 Atezolizumab Bevacizumab/placebo Gemcitabine Cisplatin (Trial)", new ValueWithNote("", "No mapping") },
            { "Doxorubicin (sarcoma)", new ValueWithNote("", "No mapping") },
            { "daNIS-3 NIS793 Tislelizumab mFOLFOX Bevacizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "ONC001 2 weekly IV monotherapy (Trial)", new ValueWithNote("", "No mapping") },
            { "Carboplatin Etoposide (oral etoposide days 2 and 3) (CrCl)", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide Fludarabine Thiotepa TBI RIC (Cord transplant)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1200) Carboplatin (CrCl)", new ValueWithNote("", "No mapping") },
            { "Goserelin", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab Paclitaxel Carboplatin EC (neoadjuvant then adjuvant) (EDTA)", new ValueWithNote("", "No mapping") },
            { "VTDPACE", new ValueWithNote("", "No mapping") },
            { "Carboplatin Etoposide (CrCl)", new ValueWithNote("", "No mapping") },
            { "Oxaliplatin Capecitabine (CapOx)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Cisplatin (70 split)", new ValueWithNote("", "No mapping") },
            { "Carboplatin (High grade glioma)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Cisplatin (25) daypt", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Pertuzumab Trastuzumab IV (neoadjuvant node positive)", new ValueWithNote("", "No mapping") },
            { "Cisplatin (50) Etoposide (50) (NSCLC) Daypt", new ValueWithNote("", "No mapping") },
            { "COSI Thiotepa Busulphan Fludarabine ATG (TBF) (Trial)", new ValueWithNote("", "No mapping") },
            { "Bortezomib Cyclophosphamide daily Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Bortezomib daily Cyclophosphamide Dexamethasone (Amyloidosis)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Pertuzumab Trastuzumab (neoadjuvant)", new ValueWithNote("", "No mapping") },
            { "Temozolomide (astrocytoma)", new ValueWithNote("", "No mapping") },
            { "Lutetium-177 oxodotreotide (without support medication)", new ValueWithNote("", "No mapping") },
            { "Carboplatin Etoposide (CrCl) (Oral etoposide days 2+3)", new ValueWithNote("", "No mapping") },
            { "SCALOP-2 Gemcitabine Paclitaxel albumin bound (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Darolutamide (non-metastatic) (support)", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab Paclitaxel Carboplatin EC (neoadjuvant then adjuvant)", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC Lenalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Anti-thymocyte globulin (ATG) equine (aplastic anaemia)", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Carboplatin (CrCl) (ovarian)", new ValueWithNote("", "No mapping") },
            { "Abiraterone Prednisolone", new ValueWithNote("", "No mapping") },
            { "Liposomal doxorubicin (sarcoma)", new ValueWithNote("", "No mapping") },
            { "Pembrolizumab Paclitaxel Carboplatin EC (neoadjuvant then adjuvant) (CrCl)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel weekly Pertuzumab Trastuzumab IV (adjuvant use only)", new ValueWithNote("", "No mapping") },
            { "Cabozantinib (RCC)", new ValueWithNote("", "No mapping") },
            { "Pertuzumab (neoadjuvant)", new ValueWithNote("", "No mapping") },
            { "Cabozantinib (compassionate use)", new ValueWithNote("", "No mapping") },
            { "Cisplatin Dexamethasone Gemcitabine PEG-Asparaginase (DDGP)", new ValueWithNote("", "No mapping") },
            { "ASTX727-02 ASTX727 then Decitabine (Trial)", new ValueWithNote("", "No mapping") },
            { "Cabazitaxel", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Pertuzumab Trastuzumab IV (neoadjuvant node negative / unknown)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel Ifosfamide Cisplatin (TIP)", new ValueWithNote("", "No mapping") },
            { "Gemtuzumab Daunorubicin Cytarabine consolidation", new ValueWithNote("", "No mapping") },
            { "BGB-3111-LTE1 Zanubrutinib (Trial)", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide Etoposide Procarbazine Prednisolone maintenance (PEP-C)", new ValueWithNote("", "No mapping") },
            { "Carfilzomib Lenalidomide Dexamethasone (CarLenDex)", new ValueWithNote("", "No mapping") },
            { "Palbociclib", new ValueWithNote("", "No mapping") },
            { "Carboplatin Fluorouracil (CrCl) (H&N) daypt", new ValueWithNote("", "No mapping") },
            { "Neratinib", new ValueWithNote("", "No mapping") },
            { "Bevacizumab (7.5mg/kg) Paclitaxel Carboplatin (CrCl) (ovarian)", new ValueWithNote("", "No mapping") },
            { "Thiotepa Busulfan Fludarabine ATG (Allograft)", new ValueWithNote("", "No mapping") },
            { "Topotecan (oral)", new ValueWithNote("", "No mapping") },
            { "Fludarabine TBI post transplant Cyclophosphamide MUD", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide Dexamethasone Rituximab (DRC)", new ValueWithNote("", "No mapping") },
            { "Sorafenib", new ValueWithNote("", "No mapping") },
            { "Bortezomib weekly Cyclophosphamide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Pertuzumab Trastuzumab (neoadjuvant node positive)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel weekly Phesgo SC (adjuvant use only)", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC Bortezomib Thalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Bortezomib", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Carboplatin (CrCl)", new ValueWithNote("", "No mapping") },
            { "TOPAZ-1 Gemcitabine Cisplatin Durvalumab / placebo (Trial)", new ValueWithNote("", "No mapping") },
            { "Ifosfamide Etoposide (5 day)", new ValueWithNote("", "No mapping") },
            { "Bevacizumab (15mg/kg) Paclitaxel Carboplatin (CrCl) (ovarian)", new ValueWithNote("", "No mapping") },
            { "Darolutamide Docetaxel Prednisolone", new ValueWithNote("", "No mapping") },
            { "Carboplatin Paclitaxel Trastuzumab (GOJ) (CrCl)", new ValueWithNote("", "No mapping") },
            { "Cisplatin (75) Etoposide (100) (Neuroendocrine) daypt", new ValueWithNote("", "No mapping") },
            { "VIP Cisplatin Etoposide Ifosfamide", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Cisplatin (70) daypt", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Pertuzumab Trastuzumab (neoadjuvant node positive) CrCl", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Cisplatin (70)", new ValueWithNote("", "No mapping") },
            { "Cyclophosphamide Etoposide Procarbazine Prednisolone induction (PEP-C)", new ValueWithNote("", "No mapping") },
            { "Paclitaxel weekly Phesgo SC (following completion of EC cycles)", new ValueWithNote("", "No mapping") },
            { "Fludarabine Cyclophosphamide Alemtuzumab (Aplastic Anemia) (Allograft)", new ValueWithNote("", "No mapping") },
            { "Trabectedin (sarcoma)", new ValueWithNote("", "No mapping") },
            { "Midostaurin Daunorubicin Cytarabine", new ValueWithNote("", "No mapping") },
            { "Olaparib TABLETS (300mg bd)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Fluorouracil Oxaliplatin (FLOT)", new ValueWithNote("", "No mapping") },
            { "Temozolomide 150/200", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (1000) Cisplatin (25)", new ValueWithNote("", "No mapping") },
            { "Ribociclib", new ValueWithNote("", "No mapping") },
            { "Nivolumab Vinorelbine (oral) Carboplatin (neoadjuvant) (CrCl)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Pertuzumab Trastuzumab IV (neoadjuvant node positive)CrCl", new ValueWithNote("", "No mapping") },
            { "Daratumumab SC Pomalidomide Dexamethasone", new ValueWithNote("", "No mapping") },
            { "Darolutamide (non-metastatic)", new ValueWithNote("", "No mapping") },
            { "Docetaxel Carboplatin Pertuzumab Trastuzumab (neoadjuvant node neg/unknown)CrCl", new ValueWithNote("", "No mapping") },
            { "Trabectedin", new ValueWithNote("", "No mapping") },
            { "Gemcitabine (lymphoma)", new ValueWithNote("", "No mapping") },
            { "Lenvatinib (Thyroid)", new ValueWithNote("", "No mapping") },
            { "Olaparib (adjuvant)", new ValueWithNote("", "No mapping") },
            { "Liposomal doxorubicin (support)", new ValueWithNote("", "No mapping") },
            { "Streptozocin Capecitabine", new ValueWithNote("", "No mapping") },
            { "EC Docetaxel Pertuzumab Trastuzumab (neoadjuvant node negative / unknown)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm B Intensification (off study)", new ValueWithNote("", "No mapping") },
            { "Aprepitant oral", new ValueWithNote("", "No mapping") },
            { "MATRIX NLMT Arm C (Palbociclib) (Trial)", new ValueWithNote("", "No mapping") },
            { "Momelotinib (Compassionate Use)", new ValueWithNote("", "No mapping") },
            { "Trastuzumab SC 21 day (support)", new ValueWithNote("", "No mapping") },
            { "EP", new ValueWithNote("", "No mapping") },
            { "LUD2015-005 Cohort D2 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "CT7001-001 Module 4 Cycle 1 onwards (Trial)", new ValueWithNote("", "No mapping") },
            { "Atezolizumab 28 day (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "Constellation (0610-02) Arm 3 CPI-0610 125mg + Rux R(-1) (Trial)", new ValueWithNote("", "No mapping") },
            { "Cisplatin hydration (cisplatin dose 41-60mg/m2)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 302 Cohort 1c NUC-3373 + LV (Trial)", new ValueWithNote("", "No mapping") },
            { "ALKS 4230-006 ARTISTRY-6 cohort 2 (Trial)", new ValueWithNote("", "No mapping") },
            { "OCTOVA Arm B (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "UKALL 60+ Arm B and D Maintenance (off study)", new ValueWithNote("", "No mapping") },
            { "PLATFORM Arm A3 MEDI4736 maintenance (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Cisplatin weekly (ovarian) daypt", new ValueWithNote("", "No mapping") },
            { "RXC004/0001 (Trial)", new ValueWithNote("", "No mapping") },
            { "Aprepitant Dexamethasone (day 1 on ward)", new ValueWithNote("", "No mapping") },
            { "CXD101-0901; CXD101 expansion (early phase trial)", new ValueWithNote("", "No mapping") },
            { "Samuraciclib (compassionate use)", new ValueWithNote("", "No mapping") },
            { "D933LC00001 (BEGONIA) Arm 7 (Trial)", new ValueWithNote("", "No mapping") },
            { "MITHRIDATE (RG_16-148) Hydroxycarbamide (Trial)", new ValueWithNote("", "No mapping") },
            { "EDP daypatient", new ValueWithNote("", "No mapping") },
            { "ADCT-301-201 (Trial)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 701 weekly (Trial)", new ValueWithNote("", "No mapping") },
            { "CompARE Arm 1 Cisplatin 40mg/m2 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "WO41554 (Trial)", new ValueWithNote("", "No mapping") },
            { "PETRA (D9720C00001) Module 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "Mifamurtide (support)", new ValueWithNote("", "No mapping") },
            { "RP3-301 RP3 monotherapy cohorts 3 and 4 (Trial)", new ValueWithNote("", "No mapping") },
            { "2102-HEM-101 FT-2102 twice daily (Trial)", new ValueWithNote("", "No mapping") },
            { "ACE-536-MDS-001 (MEDALIST) (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "UKALL 14 Imatinib (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "RP3-301 RP3 Nivolumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Nivolumab 28 day (relapsed/metastatic)", new ValueWithNote("", "No mapping") },
            { "UKALL 2011 Regimen B Standard interim maintenance (off study)", new ValueWithNote("", "No mapping") },
            { "ADVANCE Group 2 (Trial)", new ValueWithNote("", "No mapping") },
            { "LOXO-BTK-18001 (Trial)", new ValueWithNote("", "No mapping") },
            { "Sodium choride 0.9% 1000ml IV infusion over 60 minutes", new ValueWithNote("", "No mapping") },
            { "ONC001 Part B (Trial)", new ValueWithNote("", "No mapping") },
            { "Cetuximab / Panitumumab skin toxicity", new ValueWithNote("", "No mapping") },
            { "AMMO Arm A ASTX727 (Trial)", new ValueWithNote("", "No mapping") },
            { "ALKS 4230-006 ARTISTRY-6 cohort 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "RS-TS-101-01 (Trial)", new ValueWithNote("", "No mapping") },
            { "Dapsone", new ValueWithNote("", "No mapping") },
            { "Paracetamol IV", new ValueWithNote("", "No mapping") },
            { "CHARIOT M6620 Tuesday doses (Trial)", new ValueWithNote("", "No mapping") },
            { "NUTIDE 301 part 1 (NUC-3373 weekly) (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "RADAR (Myeloma XV) RCyBorIsaD (Trial)", new ValueWithNote("", "No mapping") },
            { "Rituximab IV 100mg (ITP)", new ValueWithNote("", "No mapping") },
            { "Cardamon consolidation (CarCyDex) (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "IMG-7289-CTP-201 IMG-7289 (Trial)", new ValueWithNote("", "No mapping") },
            { "IMP-MEL IMM60 Pembrolizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Venetoclax doses for delay in titration (add in on date of delay) (support)", new ValueWithNote("", "No mapping") },
            { "DREAMM-9 Belantamab mafodontin Rd maintenance (Trial)", new ValueWithNote("", "No mapping") },
            { "BGB-3111-302 BGB-3111 (NCRN Trial)", new ValueWithNote("", "No mapping") },
            { "Mouth and Bowel Support Minus Metoclopramide", new ValueWithNote("", "No mapping") },
            { "DREAMM-9 Belantamab mafodontin VRd (Trial)", new ValueWithNote("", "No mapping") },
            { "CHARIOT M6620 Friday doses (Trial)", new ValueWithNote("", "No mapping") },
            { "Ipi-Glio Arm B (Trial)", new ValueWithNote("", "No mapping") },
            { "Aprepitant already has antiemetic dexamethasone prescribed (day 1 on ward)", new ValueWithNote("", "No mapping") },
            { "Cisplatin hydration daypatient", new ValueWithNote("", "No mapping") },
            { "Hydroxycarbamide (3 months)", new ValueWithNote("", "No mapping") },
            { "RXC004/0001 Module 2 (Trial)", new ValueWithNote("", "No mapping") },
            { "ASTX660-01 (7 days on/7 days off) (Trial)", new ValueWithNote("", "No mapping") },
            { "Lansoprazole 5 day", new ValueWithNote("", "No mapping") },
            { "UCL/17/0629 (PROMPT) Pembrolizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "Aprepitant already has antiemetic dexamethasone prescribed (day 1 at home)", new ValueWithNote("", "No mapping") },
            { "BP42675 RO7122290 Cibisatamab part 1 (Trial)", new ValueWithNote("", "No mapping") },
            { "GCSF lenograstim", new ValueWithNote("", "No mapping") },
            { "MidAC", new ValueWithNote("", "No mapping") },
            { "GS-US-352-4365 (Trial)", new ValueWithNote("", "No mapping") },
            { "MIV-818-101/201 (Trial)", new ValueWithNote("", "No mapping") },
            { "DS3201-A-U202 (Valentine) (Trial)", new ValueWithNote("", "No mapping") },
            { "SCIB1-002 Pembrolizumab SCIB1 (Trial)", new ValueWithNote("", "No mapping") },
            { "NG-350A-02 (FORTIFY) NG-350A Pembrolizumab (Trial)", new ValueWithNote("", "No mapping") },
            { "LOXO-BTK-20019 Arm A LOXO-305 (Trial)", new ValueWithNote("", "No mapping") },
            { "MOTION Vismeltinib / placebo (Trial)", new ValueWithNote("", "No mapping") },
        };
