...
internal class RaceConceptLookup : ILookup
{
    public Dictionary<string, ValueWithNote> Mappings { get; } =
        new()
        {
            ...
            { "D", new ValueWithNote("8527",   "Mixed - White and Black Caribbean [Athena mapping](https://athena.ohdsi.org/search-terms/terms/700388)") },
            { "E", new ValueWithNote("8527",   "Mixed - White and Black African [Athena mapping](https://athena.ohdsi.org/search-terms/terms/700389)") },
            { "F", new ValueWithNote("8527",   "Mixed - White and Asian [Athena mapping](https://athena.ohdsi.org/search-terms/terms/700390)") },
            { "G", new ValueWithNote("8527",   "Mixed - Any other mixed background [Athena mapping](https://athena.ohdsi.org/search-terms/terms/700391)") },
