...
internal class NhsCriticalCareActivityCodeLookup : ILookup
{
    public Dictionary<string, ValueWithNote> Mappings { get; } =      
        new()
        {
            ...
            { "27", new ValueWithNote("4301936", "Special monitoring") },
            ...
            { "55", new ValueWithNote("4082245", "Nasopharyngeal airway") },
            ...
            { "62", new ValueWithNote("4322479", "Central venous pressure monitoring") },
