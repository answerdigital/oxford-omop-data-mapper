...
internal class RxNormLookup : ILookup
{
    public Dictionary<string, ValueWithNote> Mappings { get; } =
        new()
        {
            ...
            { "hepatitis A-hepatitis B vaccine", new ValueWithNote("36028822", "Hepatitis A Vaccine, Inactivated / Hepatitis B Vaccine") },            //            { "sodium bicarbonate-sodium chloride top", new ValueWithNote(null, null) },
