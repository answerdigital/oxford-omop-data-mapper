...
internal class NhsAETreatmentLookup : ILookup
{
    public Dictionary<string, ValueWithNote> Mappings { get; } =      
        new()
        {
            ...
            { "12", new ValueWithNote("44810625", "IV Cannula") },    
            ...
            // { "22", new ValueWithNote(null, "Guidance") },
            // { "221", new ValueWithNote(null, "Guidance - written") }, 
            // { "222", new ValueWithNote(null, "Guidance - verbal") },  
            ...
            // { "29", new ValueWithNote(null, "Parenteral Drugs") },    
            ...
            // { "32", new ValueWithNote(null, "X-ray Review") },        
            // { "33", new ValueWithNote(null, "Fracture Review") },     
            ...
            // { "40", new ValueWithNote(null, "Supplemental Oxygen") }, 
            ...
            { "522", new ValueWithNote("4236269", "OT - OT activities of daily living equipment provision") },
            { "53", new ValueWithNote("4083010", "Walking Aid Loan") },
            { "54", new ValueWithNote("4204655", "Social Work") },    
            ...
            // { "56", new ValueWithNote(None, "Dental") },
            { "57", new ValueWithNote("4052492", "Prescription") },   
            // { "27", new ValueWithNote(None, "Other") },
            // { "99", new ValueWithNote(None, "None") },
        };
