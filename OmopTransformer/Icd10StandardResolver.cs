...
internal class Icd10StandardResolver : Icd10Resolver
{
    public Icd10StandardResolver(IOptions<Configuration> configuration, ILogger<Icd10Resolver> logger) : base(configuration, logger)
    {
    }
